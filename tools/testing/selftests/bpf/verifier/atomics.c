{
	...
	BPF_ATM_XFADD(BPF_REG_10, -8, BPF_REG_1),
...
},
{
	...
	.insns = {
		BPF_MOV64_IMM(BPF_REG_0, 0),
		BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 3),
		BPF_ATM_XFADD(BPF_REG_10, -8, BPF_REG_10),
		BPF_EXIT_INSN(),
	},
	.result = REJECT,
...
},
{
	...
	.insns = {
		BPF_MOV64_IMM(BPF_REG_0, 0),
		BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 3),
		BPF_ATM_XFADD(BPF_REG_10, -8, BPF_REG_2),
		BPF_EXIT_INSN(),
	},
	.result = REJECT,
...
},
{
	...
	.insns = {
		BPF_MOV64_IMM(BPF_REG_0, 0),
		BPF_ATM_XFADD(BPF_REG_2, -8, BPF_REG_0),
		BPF_EXIT_INSN(),
	},
	.result = REJECT,
	/* It happens that the address leak check is first, but it would also be
...
},
{
	...
	.insns = {
		...
		BPF_ATM_XFADD(BPF_REG_2, 0, BPF_REG_3),
		/* Done */
		BPF_MOV64_IMM(BPF_REG_0, 0),
		BPF_EXIT_INSN(),
	},
